...
//        Page<Member> page = memberRepository.findByAge(age, pageRequest);
        Page<Member> page = memberRepository.findDivByAge(age, pageRequest);
...
//        assertThat(page.getTotalPages()).isEqualTo(2);
    ...
    public void bulkUpdate() {
        ...
        // when
        int resultCount = memberRepository.bulkAgePlus(20); // 벌크연산 시 db 바로 적용함. 영속성 컨텍스트에서는 모름
//        em.clear();                                       // 그러므로 클리어, 이 방법 또는 스프링 데이터 JPA 에서는 Modifying 속성에서 설정 가능
